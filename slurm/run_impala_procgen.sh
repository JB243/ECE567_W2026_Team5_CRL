#!/bin/bash
#SBATCH --job-name=impala_procgen
#SBATCH --array=1
#SBATCH --output=slurm/logs/impala_procgen_%A_%a.out
#SBATCH --error=slurm/logs/impala_procgen_%A_%a.err
...
/home/lalkarmi/miniconda3/envs/cora_minihack/bin/python main.py \
    --config-file configs/procgen/impala_procgen.json \
    --output-dir tmp/impala_procgen_run${SLURM_ARRAY_TASK_ID}
