#!/bin/bash
#SBATCH --job-name=impala_minihack
#SBATCH --array=1-2
#SBATCH --output=slurm/logs/impala_%A_%a.out
#SBATCH --error=slurm/logs/impala_%A_%a.err
...
/home/lalkarmi/miniconda3/envs/cora_minihack/bin/python main.py \
    --config-file configs/minihack/impala_minihack_paperdefaults.json \
    --output-dir tmp/impala_run${SLURM_ARRAY_TASK_ID}
