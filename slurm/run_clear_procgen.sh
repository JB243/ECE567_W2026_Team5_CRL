#!/bin/bash
#SBATCH --job-name=clear_procgen
#SBATCH --array=1
#SBATCH --output=slurm/logs/clear_procgen_%A_%a.out
#SBATCH --error=slurm/logs/clear_procgen_%A_%a.err
...
/home/lalkarmi/miniconda3/envs/cora_minihack/bin/python main.py \
    --config-file configs/procgen/clear_procgen.json \
    --output-dir tmp/clear_procgen_run${SLURM_ARRAY_TASK_ID}
