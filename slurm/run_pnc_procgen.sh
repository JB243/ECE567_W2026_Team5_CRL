#!/bin/bash
#SBATCH --job-name=pnc_procgen
#SBATCH --array=1-5
#SBATCH --output=slurm/logs/pnc_procgen_%A_%a.out
#SBATCH --error=slurm/logs/pnc_procgen_%A_%a.err
...
/home/lalkarmi/miniconda3/envs/cora_minihack/bin/python main.py \
    --config-file configs/procgen/pnc_procgen.json \
    --output-dir tmp/pnc_procgen_run${SLURM_ARRAY_TASK_ID}
